                                    ...
                                    <figure>
                                        <div class="product_thumb">
                                            <a href="single-product.html"><img
                                                    src="{{asset('main/img/product/product1.png')}}" alt=""></a>
                                            <div class="action_links">
                                                <ul class="d-flex justify-content-center">
                                                    ...
                                                    <li class="wishlist"><a href="#"
                                                                ...
                                                                class="pe-7s-like2 --bs-danger"></span></a></li>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <article class="single_product wow fadeInUp" data-wow-delay="0.2s"
                                    ...
                                    <figure>
                                        <div class="product_thumb">
                                            <a href="single-product.html"><img
                                                    src="{{asset('main/img/product/product2.png')}}" alt=""></a>
                                            <div class="action_links">
                                                <ul class="d-flex justify-content-center">
                                                    <li class="add_to_cart"><a href="cart.html"
                                                                               title="Add to cart">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <article class="single_product wow fadeInUp" data-wow-delay="0.3s"
                                    ...
                                    <figure>
                                        <div class="product_thumb">
                                            <a href="single-product.html"><img
                                                    src="{{asset('main/img/product/product3.png')}}" alt=""></a>
                                            <div class="action_links">
                                                <ul class="d-flex justify-content-center">
                                                    <li class="add_to_cart"><a href="cart.html"
                                                                               title="Add to cart">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <article class="single_product wow fadeInUp" data-wow-delay="0.1s"
                                    ...
                                    <figure>
                                        <div class="product_thumb">
                                            <a href="single-product.html"><img
                                                    src="{{asset('main/img/product/product4.png')}}" alt=""></a>
                                            <div class="action_links">
                                                <ul class="d-flex justify-content-center">
                                                    <li class="add_to_cart"><a href="cart.html"
                                                                               title="Add to cart">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <article class="single_product wow fadeInUp" data-wow-delay="0.2s"
                                    ...
                                    <figure>
                                        <div class="product_thumb">
                                            <a href="single-product.html"><img
                                                    src="{{asset('main/img/product/product5.png')}}" alt=""></a>
                                            <div class="action_links">
                                                <ul class="d-flex justify-content-center">
                                                    <li class="add_to_cart"><a href="cart.html"
                                                                               title="Add to cart">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <article class="single_product wow fadeInUp" data-wow-delay="0.3s"
                                    ...
                                    <figure>
                                        <div class="product_thumb">
                                            <a href="single-product.html"><img
                                                    src="{{asset('main/img/product/product6.png')}}" alt=""></a>
                                            <div class="action_links">
                                                <ul class="d-flex justify-content-center">
                                                    <li class="add_to_cart"><a href="cart.html"
                                                                               title="Add to cart">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <article class="single_product wow fadeInUp" data-wow-delay="0.1s"
                                    ...
                                    <figure>
                                        <div class="product_thumb">
                                            <a href="single-product.html"><img
                                                    src="{{asset('main/img/product/product7.png')}}" alt=""></a>
                                            <div class="action_links">
                                                <ul class="d-flex justify-content-center">
                                                    <li class="add_to_cart"><a href="cart.html"
                                                                               title="Add to cart">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <article class="single_product wow fadeInUp" data-wow-delay="0.2s"
                                    ...
                                    <figure>
                                        <div class="product_thumb">
                                            <a href="single-product.html"><img
                                                    src="{{asset('main/img/product/product8.png')}}" alt=""></a>
                                            <div class="action_links">
                                                <ul class="d-flex justify-content-center">
                                                    <li class="add_to_cart"><a href="cart.html"
                                                                               title="Add to cart">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <article class="single_product wow fadeInUp" data-wow-delay="0.3s"
                                    ...
                                    <figure>
                                        <div class="product_thumb">
                                            <a href="single-product.html"><img
                                                    src="{{asset('main/img/product/product9.png')}}" alt=""></a>
                                            <div class="action_links">
                                                <ul class="d-flex justify-content-center">
                                                    <li class="add_to_cart"><a href="cart.html"
                                                                               title="Add to cart">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <article class="single_product wow fadeInUp" data-wow-delay="0.1s"
                                    ...
                                    <figure>
                                        <div class="product_thumb">
                                            <a href="single-product.html"><img
                                                    src="{{asset('main/img/product/product10.png')}}" alt=""></a>
                                            <div class="action_links">
                                                <ul class="d-flex justify-content-center">
                                                    <li class="add_to_cart"><a href="cart.html"
                                                                               title="Add to cart">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <article class="single_product wow fadeInUp" data-wow-delay="0.2s"
                                    ...
                                    <figure>
                                        <div class="product_thumb">
                                            <a href="single-product.html"><img
                                                    src="{{asset('main/img/product/product11.png')}}" alt=""></a>
                                            <div class="action_links">
                                                <ul class="d-flex justify-content-center">
                                                    <li class="add_to_cart"><a href="cart.html"
                                                                               title="Add to cart">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <article class="single_product wow fadeInUp" data-wow-delay="0.3s"
                                    ...
                                    <figure>
                                        <div class="product_thumb">
                                            <a href="single-product.html"><img
                                                    src="{{asset('main/img/product/product12.png')}}" alt=""></a>
                                            <div class="action_links">
                                                <ul class="d-flex justify-content-center">
                                                    <li class="add_to_cart"><a href="cart.html"
                                                                               title="Add to cart">
