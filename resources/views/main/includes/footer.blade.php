        ...
        <div class="shipping_area">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="single_shipping d-flex align-items-center">
                        <div class="shipping_icon">
                            <img src="{{asset('main/img/others/shipping1.png')}}" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="single_shipping d-flex align-items-center">
                        <div class="shipping_icon">
                            <img src="{{asset('main/img/others/shipping2.png')}}" alt="">
                        </div>
                        <div class="shipping_text">
                            <h3>Card Payments</h3>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="single_shipping d-flex align-items-center">
                        <div class="shipping_icon">
                            <img src="{{asset('main/img/others/shipping3.png')}}" alt="">
                        </div>
                        <div class="shipping_text">
                            <h3>Easy Returns</h3>
                        ...
                        <div class="footer_widget_list footer_list_width">
                            ...
                            <div class="footer_newsletter">
                                ...
                                <div class="footer_paypal">
                                    <a href="#"><img src="{{asset('main/img/others/paypal.png')}}" alt=""></a>
                                </div>
                            </div>
                        </div>
                    </div>
